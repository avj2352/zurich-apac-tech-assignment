...
const SimpleSpinner:FunctionComponent<ISimpleSpinnerProps> = ({isLoading}):JSX.Element => {    
    const content:JSX.Element = Boolean(isLoading) ? <ContainerStyled><svg
